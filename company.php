...
<head>
	...
	<title>incloud Jobs - <?php echo "$compname"; ?></title>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<h5 class="footer-title">About incloud Jobs</h5>
											<p>incloud Jobs is a job portal, online job management system developed by Biniyam Nebsofor his project in september 2023.</p>
