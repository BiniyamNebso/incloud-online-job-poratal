					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> location <br/> PO.BOX postal address, <br/>company's location</address>
								</li>
								<li>
										<h5>Email</h5><a href="company's email">company's email</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+telephone number">+phone number</a>
								</li>
				...
				<div class="main-footer">
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-9">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<h5 class="footer-title">About incloud Jobs</h5>
											<p>incloud Jobs is a job portal, online job management system developed by Biniyam Nebso for his project in september 2023.</p>
							...
							<h5 class="footer-title">incloud Jobs Contact</h5>
								
								<p>Address : locatin of company's office  PO.BOX postal address</p>
								<p>Email : <a href="company's email">company's email</a></p>
								<p>Phone : <a href="tel:telephone number">+phone number/a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> incloud Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Biniyam Nebso</a></li>
								</ul>
